      ...
      <div className="row text-center text-xs-center text-sm-left text-md-left">
        <div className="col-xs-12 col-sm-4 col-md-4">
          ...
          <ul className="list-unstyled quick-links">
            <li><a href="javascript:void();"><i className="fa fa-angle-double-right"></i>Accueil</a></li>
            <li><a href="javascript:void();"><i className="fa fa-angle-double-right"></i>Qui somme nous?</a></li>
            <li><a href="javascript:void();"><i className="fa fa-angle-double-right"></i>Objectifs</a></li>
            <li><a href="javascript:void();"><i className="fa fa-angle-double-right"></i>Notre membres</a></li>
            <li><a href="javascript:void();"><i className="fa fa-angle-double-right"></i>Contribuer</a></li>
          </ul>
        </div>
        <div className="col-xs-12 col-sm-4 col-md-4">
          <h5>NOS BRANCHES</h5>
